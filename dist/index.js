...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = function (_React$Component) {
	    ...
	    _createClass(Tile, [{
	        key: "render",
	        value: function render() {
	            var className = this.props.tile.isEmpty() ? "tile empty" : "tile";
	            return _react2.default.createElement(
	                "div",
	                { className: className, onClick: this._handleClick },
	                this.props.tile.number
	            );
	        }
	    }, {
	        key: "_handleClick",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TilePuzzle = function () {
	    ...
	    function TilePuzzle() {
	        _classCallCheck(this, TilePuzzle);
	    ...
	    _createClass(TilePuzzle, [{
	        key: 'init',
	        value: function init() {
	            var _this = this;

	            for (var i = 1; i <= this.TILES_NUMBER; ++i) {
	                var tile = new _Tile2.default(i);
	                tile.addOnSwitchListener(this);
	                this.tiles.push(tile);
	            }
	            this.tiles.push(new _Tile2.default(null)); // Empty tile
	            ...
	            this.tiles.forEach(function (tile) {
	                tile.setPosition(new _TilePosition2.default(rowNumber, rowPosition++));
	                if (rowPosition > _this.TILES_PER_ROW) {
	                    rowPosition = 1;
	                    rowNumber++;
	                }
	            });
	        ...
	        key: 'get',
	        value: function get(rowNumber, rowPosition) {
	            var index = this._getIndexForPosition(new _TilePosition2.default(rowNumber, rowPosition));
	        ...
	        key: 'switchTiles',
	        value: function switchTiles(tile) {
	            var otherTile = null;
	            var otherTilePositions = [new _TilePosition2.default(tile.tilePosition.rowNumber + 1, tile.tilePosition.rowPosition), new _TilePosition2.default(tile.tilePosition.rowNumber, tile.tilePosition.rowPosition + 1), new _TilePosition2.default(tile.tilePosition.rowNumber - 1, tile.tilePosition.rowPosition), new _TilePosition2.default(tile.tilePosition.rowNumber, tile.tilePosition.rowPosition - 1)];
	            while (otherTilePositions.length > 0 && !otherTile) {
	                var otherTilePosition = otherTilePositions.shift();
	            ...
	            if (otherTile) {
	                var _otherTilePosition = this._getIndexForPosition(otherTile.tilePosition);
	                var tilePosition = this._getIndexForPosition(tile.tilePosition);
	                this.tiles[_otherTilePosition] = tile;
	        ...
	        key: '_getIndexForPosition',
	        value: function _getIndexForPosition(tilePosition) {
